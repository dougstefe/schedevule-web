...
export default function FormButtons(props: Props) {
    ...
    function renderButtonToRemove() {
        return (
            <div className="sm:col-span-6 flex justify-center excluir">
                <button type='button' className="flex align-center bg-indigo-900 rounded-md px-4 py-2" onClick={props.remove}>
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
    ...
    return (
        props.showSaveButtons ? renderButtonsToSave() : renderButtonToRemove()
    )
}